...
class EditUser extends React.Component{
  ...
  render(){
    const classes = classnames('__EditUser')
      ...
      <Grid className={classes+"__Grid"}>
        <Row className={classes+"__Grid__Row"}>
          <Cell className={classes+"__Grid__Row__Cell"} columns={12}>
            <Header className={classes+"__Grid__Row__Cell__Header"}title="Edit User" arrow="arrow_back" arrowLink={()=> this.backTo("/userprofile")}/>
          </Cell>
        </Row>
        <Row className={classes+"__Grid__Row"}>
